...
<div class="form">
    <form action="Includes/DailyRecords.inc.php" method="post">
        ...
        <input type="date" name="Record_Date" placeholder="Record Date"><br>
        
        <label for="Record_Time">Record Time</label><br>
        <input type="time" name="Record_Time" placeholder="Record Time"><br>
