...
<div class="form">
    <form action="Includes/Register.inc.php" method="post">
        ...
        <input type="date" name="Start_Date" placeholder="Date Starting"><br>
        
        <label for="End_Date">End Date</label><br>
        <input type="date" name="End_Date" placeholder="Date of Ending"><br>
        
        <label for="Contract_No">Contract No</label><br>
        <input type="text" name="Contract_No" placeholder="Contract No"><br>
