...
<div class="form">
    <form action="Includes/Adddrug.inc.php" method="post">
        <label for="Drug_Name">Drug Name</label><br>
        <input type="text" name="Drug_Name" placeholder="Drug Name"><br>

        <label for="Unit_Cost">Unit Cost</label><br>
        <input type="text" name="Unit_Cost" placeholder="Unit Cost"><br>
