...
<div class="output">
    ...
    $sql1 = "SELECT employee.EmpNo,employee.Name,employee.Address,employee.Working_Status,employee.Type,employee.Contact_No,medical_staff.Type as Role,medical_staff.Joined_Date,medical_staff.Resign_Date,medical_staff.Council_RegNo,doctor.DEA_No FROM employee JOIN medical_staff ON employee.EmpNo=medical_staff.EmpNo JOIN doctor ON medical_staff.EmpNo=doctor.EmpNo;";
